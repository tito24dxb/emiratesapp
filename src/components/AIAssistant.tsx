...
export default function AIAssistant({ isOpen, onClose, initialMode = 'coach' }: AIAssistantProps) {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-20 right-4 md:right-6 w-[calc(100vw-2rem)] md:w-96 h-[600px] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden z-[9999] border border-gray-200"
    >
