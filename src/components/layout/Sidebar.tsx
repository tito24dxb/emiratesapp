...
export default function Sidebar() {
  ...
  return (
    <aside className="w-full md:w-64 border-b md:border-b-0 md:border-r border-white/10 md:h-[calc(100vh-5rem)] md:sticky md:top-20 overflow-y-auto backdrop-blur-3xl" style={{background: 'var(--sidebar-bg)'}}>
