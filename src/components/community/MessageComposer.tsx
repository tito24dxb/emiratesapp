    ...
    <div className="glass-light relative">
      ...
      <div className="flex items-end gap-3">
        ...
        <button
          ...
          className="p-3 bg-gradient-to-r from-[#D71921] to-[#B01419] hover:shadow-lg rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
        >
          {sending ? (
