...
import { Flag, Plus, Edit2, Trash2, ToggleLeft, ToggleRight } from 'lucide-react';
...
function CreateFlagModal({ onClose, currentUser }: CreateFlagModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Create Feature Flag</h2>
