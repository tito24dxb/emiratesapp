      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <motion.div
            ...
            className="bg-white/70 backdrop-blur-sm rounded-xl p-6 border border-gray-200/50 shadow-lg"
          >
        ...
        <div className="flex gap-4 mb-8">
          ...
          <button
            ...
            className="px-6 py-3 bg-white/30 backdrop-blur-sm hover:bg-white/40 border border-gray-200/50 text-gray-900 rounded-lg font-medium transition-all flex items-center gap-2"
          >
